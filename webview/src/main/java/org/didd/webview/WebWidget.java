...
public class WebWidget extends FrameLayout {
    ...
    private WebViewClient client = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (debug) Log.d(TAG, "onPageStarted, url = " + url);
            isLoadFailed = false;
        }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (debug) Log.d(TAG, "onPageFinished, url = " + url);
            if (null != webView)
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            if (debug) Log.w(TAG, "onReceivedError");
    ...
    private WebChromeClient chrome = new VideoEnabledWebChromeClient() {
        ...
        public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
            if (debug) Log.d(TAG, "onJsPrompt, url = " + url);
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            if (debug) Log.d(TAG, "onProgressChanged(), newProgress = " + newProgress);
            if (null != progress)
                progress.updateProgress(newProgress / 100.f);
            if (null != webView && newProgress >= 40 && !isLoadFailed && webView.getVisibility() != View.VISIBLE) {
        ...
        public void onReceivedTitle(WebView view, String title) {
            ...
            if (debug) Log.d(TAG, "onReceivedTitle(), title = " + title);
            updateTitle(title);
        }
        ...
        public void onReceivedIcon(WebView view, Bitmap icon) {
            ...
            if (debug) Log.d(TAG, "onReceivedIcon()");
        }
        ...
        public void onGeolocationPermissionsHidePrompt() {
            ...
            if (debug) Log.d(TAG, "onGeolocationPermissionsHidePrompt");
        }

        @Override
        public void onGeolocationPermissionsShowPrompt(final String origin,
                                                       final GeolocationPermissions.Callback callback) {
            if (debug) Log.d(TAG, "onGeolocationPermissionsShowPrompt(), origin = " + origin);
            ...
            if (mContext instanceof Activity) {
                mPermissionUtil.requestPermission((Activity) mContext, new String[]{Manifest.permission.ACCESS_FINE_LOCATION,
                    ...
                    public void requestPermissionSuccess() {
                        if (debug) Log.d(TAG, "onGeolocationPermissionsShowPrompt(), per  success");
                    ...
                    public void requestPermissionFailed(boolean isTip, String permission) {
                        if (debug) Log.d(TAG, "onGeolocationPermissionsShowPrompt(), per  failed");
                        callback.invoke(origin, false, false);
                    }
        ...
        //When supporting multiple windows, it needs to be implemented
    ...
    private DownloadListener downListener = new DownloadListener() {
        ...
        public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
            ...
            if (!Environment.getExternalStorageState().equals(
                ...
                //TODO
                //Download address jump to system browser open
                openUrl(url);
            }
        }
    };
...
//            }
    ...
    private void init(Context context) {
        ...
        ((TextView) errorView).setText("Light touch screen reload");
    ...
    public void addJavascriptInterface(JsCallJava jsCallJava) {
        if (null != webView) {
            webView.addJavascriptInterface(jsCallJava);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (mContext instanceof Activity) {
            mPermissionUtil.onRequestPermissionsResult((Activity) mContext, requestCode, permissions, grantResults);
        }
    }
